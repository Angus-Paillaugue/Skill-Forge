<script>
	...
	const baseClasses =
		'w-full flex flex-row items-center relative justify-center gap-2 overflow-hidden rounded-xl px-4 py-2 text-lg font-medium transition-colors disabled:cursor-not-allowed';
