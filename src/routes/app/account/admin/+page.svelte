	...
	<div class="grid items-start gap-4 md:gap-8 lg:grid-cols-2">
		<div class="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
			...
			<div class="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
				<div
					class="flex flex-col gap-4 rounded-lg bg-neutral-800 p-6 text-neutral-100 sm:col-span-2"
				>
				...
				<!-- User count -->
				<div
					class="flex flex-row items-center gap-4 rounded-lg bg-neutral-800 p-6 text-neutral-100"
				>
					<User class="size-20" />
