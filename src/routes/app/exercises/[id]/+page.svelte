<script>
	import './code.css';
	import { Editor, Spinner, Difficulty } from '$lib/components';
...
<div class="flex flex-col h-screen gap-4 p-4">
	...
	<div class="flex shrink-0 justify-center items-center h-10">
		<div class="flex flex-row gap-0 rounded-lg overflow-hidden">
			<button
				class="px-2 py-2 text-base font-medium text-neutral-100 bg-neutral-800 flex flex-row items-center gap-2"
				onclick={runCode}
			>
			...
			<button
				class="px-2 py-2 text-base font-medium text-green-600 bg-neutral-800 flex flex-row items-center gap-2"
	...
	<div class="grid grid-cols-2 grow gap-4">
									...
									<tbody>
										{#key submissions}
											{#each submissions as submission}
												...
												>
													<td class="px-6 py-4 whitespace-pre-wrap line-clamp-3">
		...
		<div class="flex w-full flex-col gap-4">
			<!-- Main code editor -->
			<Editor language="javascript" bind:value bind:this={editor} onRunCodeShortcut={runCode} />
			<!-- Tests cases -->
