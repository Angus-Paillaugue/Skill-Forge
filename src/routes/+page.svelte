<script>
  ...
  import { ArrowBigUpDash, Shapes, ArrowRight, ShieldBan, Zap, Route, Hourglass } from 'lucide-svelte'
...
<!-- Hero -->
<section class="min-h-screen max-w-screen-xl mx-auto w-full grid grid-cols-1 lg:grid-cols-5 gap-16 px-4 py-10" id="hero">
  <!-- Left column -->
  ...
  <!-- Forms -->
  <div class="flex flex-col items-center justify-center gap-4 lg:col-span-2 w-full max-w-lg mx-auto">
    <!-- Form selector -->
    ...
    <div class="overflow-hidden w-full">
      <div class="grid grid-cols-2 gap-4 w-[calc(200%+1rem)] transition-all duration-300" style="margin-left: {formPos}px;" bind:this={formContainer}>
        <!-- Sign up form -->
        <form
...
<section class="min-h-screen space-y-6 max-w-screen-2xl mx-auto mt-10 w-full p-4" id="about">
  ...
  <div class="grid lg:grid-cols-2 w-full min-h-[80vh]">
    ...
    <div class="flex flex-col">
      ...
      <div class="shrink-0 p-4 lg:p-8 border lg:border-b-0 lg:border-r-0 border-neutral-800/50 flex flex-col gap-4 lg:gap-8 text-center justify-center items-center">
        <Hourglass class="size-16 text-[#ED5D45]" />
        <h2 class="text-4xl font-bold text-neutral-100">Learn at Your Own Pace</h2>
        <p class="font-normal text-base leading-6 font-mono text-neutral-400">Whether you're a beginner or an expert, Skill Forge allows you to progress at your own pace. Explore bite-sized exercises or dive into complex coding problems.</p>
      </div>
      <!-- Free/No ads section -->
      <div class="shrink-0 group overflow-hidden relative max-lg:border-y-0 lg:border-b-0 lg:border-r-0 p-4 lg:p-8 border border-neutral-800/50 flex flex-col gap-4 lg:gap-8 text-center justify-center items-center">
        <ShieldBan class="size-16 text-[#3F7DDE]" />
        <h2 class="text-4xl font-bold text-neutral-100">Completely Free, No Ads</h2>
        <p class="font-normal text-base leading-6 font-mono text-neutral-400">Skill Forge is a <span class="text-neutral-100 font-semibold">100% free</span> platform with no distractions. Focus entirely on your coding journey without any interruptions from ads. Learn, practice, and grow without limits.</p>
      </div>
      <!-- Get started section -->
      <div class="grow relative overflow-hidden lg:border-r-0 group p-6 border border-neutral-800/50 flex flex-col items-center justify-center gap-4">
        <button onclick={getStarted} class="text-4xl font-bold capitalize relative rounded-full transition-all hover:ring-4 hover:ring-neutral-600/50 py-2 px-4">
          Get Started
          <!-- Moving line -->
          <div
        ...
        <svg
          ...
          aria-hidden="true"
          ><defs
            ><pattern id="heroSvg" width="80" height="80" x="50%" y="-1" patternUnits="userSpaceOnUse"
    ...
    <div class="flex flex-col">
      <!-- Star -->
      <div class="grow p-4 lg:p-8 min-h-[500px] border border-neutral-800/50 max-lg:border-y-0 relative">
        <div class="absolute overflow-hidden flex flex-col items-center justify-evenly inset-8 blur-[10px]">
          {#each { length: 3 } as _}
            <h1 class="text-9xl text-center font-extrabold bg-gradient-to-r from-[#ED5D45] via-[#F2B655] to-[#3FBED8] bg-clip-text text-transparent inline-block select-none">Skill</h1>
            <h1 class="text-9xl text-center font-extrabold bg-gradient-to-r from-[#ED5D45] via-[#F2B655] to-[#3FBED8] bg-clip-text text-transparent inline-block select-none">Forge</h1>
          {/each}
        </div>
        <div class="absolute inset-12 lg:inset-24 flex flex-col items-center justify-center">
          <img src="/Star.svg" draggable="false" class="w-full max-w-[400px] h-full object-contain" alt="">
        </div>
      </div>
      <!-- Two cards side to side -->
      <div class="grid lg:grid-cols-2 w-full shrink-0">
        <div class="p-4 lg:p-8 flex flex-col gap-4 border lg:border-t-0 lg:border-r-0 border-neutral-800/50">
          <Zap class="size-16 text-[#3FBED8]" />
          <h1 class="text-2xl font-semibold text-neutral-100">1800 + Coding Exercises</h1>
          <p class="text-base leading-6 font-normal font-mono text-neutral-400">Practice with a vast collection of coding challenges across various difficulty levels and topics.</p>
        </div>
        <div class="p-4 lg:p-8 flex flex-col gap-4 max-lg:border-t-0 border lg:border-t-0 border-neutral-800/50">
          <Route class="size-16 text-[#F2B655]" />
          <h1 class="text-2xl font-semibold text-neutral-100">Progress Tracking</h1>
          <p class="text-base leading-6 font-normal font-mono text-neutral-400">Monitor your progress, identify areas for improvement, and track your coding skills growth.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- Footer -->
<footer class="flex flex-row gap-12 bg-neutral-200 text-neutral-900 max-w-screen-2xl mx-auto rounded-2xl py-12 px-6 mb-6 w-full">
